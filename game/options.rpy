...
define config.name = _("Joe And Mysterious Treasure")
...
define build.name = "JoeAndMysteriousTreasure"
...
define config.save_directory = "JoeAndMysteriousTreasure-1681297340"
...
## Uygulama içi satın alma ve genişletme paketleri indirmek için bir Google Play
## lisans anahtarı gerekir. Bu, Google Play geliştirici konsolunda "Services &
## APIs" sayfasında bulunabilir.
